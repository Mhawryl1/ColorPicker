...
class Window
{
  public:
    ...
    HWND CreateChildWindow(WNDPROC WndProc, HWND hwnd, const wchar_t *className, const wchar_t *windowTitle,
                           const RECT &rct, LPWSTR IDI_ICON, LPWSTR IDC_CURSOR, COLORREF color, HMENU hMenu,
                           DWORD STYLE);
    HWND CreateChildWindow(HWND hwnd, const wchar_t *className, const wchar_t *windowTitle, const RECT &pos,
